            ...
            for entry in reversed(registry):
                ...
                if hash_id and hash_id not in seen_hashes:
                    ...
                    models.append({
                        ...
                        "joblib_path": entry.get("joblib_path"),
                        "download_url": f"/api/experiments/download/{hash_id}",
                        "dataset_url": f"/api/experiments/download-dataset/{run_id}",
                        "script_url": f"/api/experiments/download-script/{run_id}",
                        "has_dataset": has_ds,
                        "has_script": has_sc,
                ...
                for joblib_file in run_dir.glob("*.joblib"):
                    ...
                    if hash_id not in seen_hashes:
                        ...
                        models.append({
                            ...
                            "download_url": f"/api/experiments/download/{hash_id}",
                            "dataset_url": f"/api/experiments/download-dataset/{run_dir.name}",
                            "script_url": f"/api/experiments/download-script/{run_dir.name}",
                            "has_dataset": has_ds,
                            "has_script": has_sc,
                            "hyperparameters": {},
                            "metrics": {},
